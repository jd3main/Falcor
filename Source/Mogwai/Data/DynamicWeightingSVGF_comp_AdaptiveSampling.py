...
def render_graph_g():
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 2, 'foveaInputType': 1, 'useHistory': False, 'alpha': 0.05000000074505806, 'foveaRadius': 200.0, 'foveaSampleCount': 4.0, 'periphSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5, 'foveaMoveDirection': 0, 'useRealTime': False, 'flickerEnabled': False, 'flickerBrightDurationMs': 1.0, 'flickerDarkDurationMs': 1.0})
    ...
    ColorMapPass1 = createPass('ColorMapPass', {'colorMap': ColorMap.Grey, 'channel': 0, 'autoRange': True, 'minValue': 0.0, 'maxValue': 16.0})
    ...
    g.addEdge('SVGFPass.Filtered image', 'ToneMapper0.src')
    g.addEdge('ToneMapper0.dst', 'SplitScreenPass3.rightInput')
    g.addEdge('ToneMapper.dst', 'SplitScreenPass3.leftInput')
    g.addEdge('DynamicWeightingSVGF.Filtered image', 'ToneMapper.src')
    g.addEdge('FoveatedPass.sampleCount', 'ColorMapPass1.input')
