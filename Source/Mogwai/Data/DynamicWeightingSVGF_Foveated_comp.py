...
def render_graph_g():
    ...
    DynamicWeightingSVGF = createPass('DynamicWeightingSVGF', {'Enabled': True, 'DynamicWeighingEnabled': True, 'Iterations': 2, 'FeedbackTap': -1, 'GradientFilterIterations': 0, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'WeightedAlpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'GradientMidpoint': 0.05000000074505806, 'GammaSteepness': 10.0, 'SelectionMode': 2, 'SampleCountOverride': -1, 'NormalizationMode': 3, 'UseInputReprojection': False, 'OutputPingPongAfterIters': 0, 'OutputPingPongIdx': 0, 'EnableDebugTag': False, 'EnableDebugOutput': False})
    g.addPass(DynamicWeightingSVGF, 'DynamicWeightingSVGF')
    DynamicWeightingSVGF0 = createPass('DynamicWeightingSVGF', {'Enabled': True, 'DynamicWeighingEnabled': False, 'Iterations': 2, 'FeedbackTap': -1, 'GradientFilterIterations': 2, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'WeightedAlpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'GradientMidpoint': 0.019999999552965164, 'GammaSteepness': 10.0, 'SelectionMode': 0, 'SampleCountOverride': -1, 'NormalizationMode': 0, 'UseInputReprojection': False, 'OutputPingPongAfterIters': 0, 'OutputPingPongIdx': 0, 'EnableDebugTag': False, 'EnableDebugOutput': False})
