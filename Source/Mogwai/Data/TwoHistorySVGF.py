...
def render_graph_g():
    ...
    TwoHistorySVGFPass = createPass('TwoHistorySVGFPass', {'Enabled': True, 'Iterations': 4, 'FeedbackTap': 1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'MomentsAlpha': 0.20000000298023224, 'MaxHistoryLength': 5.0, 'ExpectedDelay': -20.0, 'ShortHistoryMaxWeight': 10.0, 'LongHistoryMaxWeight': 40.0})
