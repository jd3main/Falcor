...
def render_graph_g():
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 2, 'foveaInputType': 0, 'useHistory': False, 'alpha': 0.05000000074505806, 'foveaRadius': 200.0, 'foveaSampleCount': 2.0, 'periphSampleCount': 1.0, 'uniformSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5, 'foveaMoveDirection': 2})
    ...
    TwoHistorySVGFPass = createPass('TwoHistorySVGFPass', {'Enabled': True, 'Iterations': 4, 'FeedbackTap': 1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'MaxHistoryWeight': 32.0, 'ShortHistoryMaxWeight': 8.0, 'LongHistoryMaxWeight': 40.0})
    ...
    ColorMapPass = createPass('ColorMapPass', {'colorMap': ColorMap.Viridis, 'channel': 0, 'autoRange': False, 'minValue': -128.0, 'maxValue': 0.0})
    ...
    ColorMapPass0 = createPass('ColorMapPass', {'colorMap': ColorMap.Viridis, 'channel': 0, 'autoRange': False, 'minValue': -128.0, 'maxValue': 0.0})
    ...
    g.addEdge('ColorMapPass.output', 'SplitScreenPass3.leftInput')
    g.addEdge('TwoHistorySVGFPass.Centroid (short)', 'ColorMapPass.input')
    g.addEdge('TwoHistorySVGFPass.Centroid (long)', 'ColorMapPass0.input')
    g.addEdge('ColorMapPass0.output', 'SplitScreenPass3.rightInput')
