...
def render_graph_g():
    ...
    g.addEdge('TwoHistorySVGFPass.Weight_W', 'CountToColor2.Count')
    g.addEdge('TwoHistorySVGFPass.Weight_U', 'CountToColor1.Count')
    g.addEdge('TwoHistorySVGFPass.Illumination_U', 'SplitScreenPass.leftInput')
    g.addEdge('TwoHistorySVGFPass.Illumination_W', 'SplitScreenPass.rightInput')
    g.addEdge('FoveatedPass.sampleCount', 'TwoHistorySVGFPass.SampleCount')
    g.addEdge('TwoHistorySVGFPass.OutGradient', 'ColorMapPass.input')
    g.addEdge('TwoHistorySVGFPass.OutGamma', 'ColorMapPass0.input')
    g.addEdge('TwoHistorySVGFPass.HistLength', 'ColorMapPass1.input')
    ...
    g.addEdge('TwoHistorySVGFPass.Illumination_W', 'ColorMapPass3.input')
    g.markOutput('ToneMapper.dst')
    g.markOutput('SplitScreenPass2.output')
    g.markOutput('ColorMapPass.output')
    g.markOutput('ColorMapPass0.output')
    g.markOutput('TwoHistorySVGFPass.OutGradient')
    g.markOutput('SplitScreenPass.output')
    g.markOutput('TwoHistorySVGFPass.PingPong')
