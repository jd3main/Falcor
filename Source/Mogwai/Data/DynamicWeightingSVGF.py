...
def render_graph_g():
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 1, 'foveaInputType': 1, 'useHistory': False, 'alpha': 0.05000000074505806, 'foveaRadius': 200.0, 'foveaSampleCount': 2.0, 'periphSampleCount': 1.0, 'uniformSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5, 'foveaMoveDirection': 0})
    ...
    DynamicWeightingSVGF = createPass('DynamicWeightingSVGF', {'Enabled': True, 'Iterations': 4, 'FeedbackTap': 1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'MomentsAlpha': 0.20000000298023224, 'MaxHistoryLength': 8.0, 'ExpectedDelay': -10.0, 'UnweightedHistoryMaxWeight': 20.0, 'WeightedHistoryMaxWeight': 20.0})
