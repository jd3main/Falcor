...
def render_graph_g():
    ...
    g.addEdge('PathTracer0.color', 'DynamicWeightingSVGF.Color')
    ...
    g.addEdge('PathTracer0.nrdEmission', 'DynamicWeightingSVGF.Emission')
