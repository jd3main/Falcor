...
def render_graph_g():
    ...
    DynamicWeightingSVGF = createPass('DynamicWeightingSVGF', {'Enabled': True, 'SpatialFilterEnabled': True, 'DynamicWeighingEnabled': False, 'Iterations': 0, 'FeedbackTap': -1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 1.0, 'WeightedAlpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'MaxGradient': 1000000.0, 'AutoMidpoint': False, 'GradientMidpoint': 0.009999999776482582, 'GammaSteepness': 100.0, 'SelectionMode': 4, 'SampleCountOverride': -1, 'NormalizationMode': 0, 'UseInputReprojection': False, 'OutputPingPongAfterIters': 0, 'OutputPingPongIdx': 0, 'EnableDebugTag': False, 'EnableDebugOutput': False, 'EnableOutputVariance': True, 'FilterGradientEnabled': False, 'BestGammaEnabled': False, 'OptimalWeightingEnabled': False})
    ...
    g.addEdge('VBufferRT.vbuffer', 'PathTracerEx.vbuffer')
    g.addEdge('VBufferRT.viewW', 'PathTracerEx.viewW')
    g.addEdge('VBufferRT.mvec', 'PathTracerEx.mvec')
