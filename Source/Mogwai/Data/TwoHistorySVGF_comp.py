...
def render_graph_g():
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 0, 'foveaInputType': 0, 'useHistory': False, 'alpha': 0.05000000074505806, 'foveaRadius': 200.0, 'foveaSampleCount': 8.0, 'periphSampleCount': 2.0, 'uniformSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5, 'foveaMoveDirection': 0})
    ...
    TwoHistorySVGFPass = createPass('TwoHistorySVGFPass', {'Enabled': True, 'Iterations': 4, 'FeedbackTap': 1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'MomentsAlpha': 0.20000000298023224, 'MaxHistoryWeight': 10.0, 'ShortHistoryMaxWeight': 4.0, 'LongHistoryMaxWeight': 128.0})
    ...
    g.addEdge('FoveatedPass.sampleCount', 'MySVGFPass.HistoryWeight')
