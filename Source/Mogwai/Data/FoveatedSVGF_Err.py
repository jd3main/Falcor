...
def render_graph_DefaultRenderGraph():
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 1, 'foveaInputType': 1, 'useHistory': True, 'alpha': 0.20000000298023224, 'foveaRadius': 200.0, 'foveaSampleCount': 8.0, 'periphSampleCount': 2.0, 'uniformSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5})
    ...
    g.addPass(TAA, 'TAA')
    MySVGFPass = createPass('MySVGFPass', {'Enabled': True, 'Iterations': 4, 'FeedbackTap': 1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'UseSampleCount': True, 'Boost': True})
