...
def render_graph_g():
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 2, 'foveaInputType': 1, 'useHistory': False, 'alpha': 0.05000000074505806, 'foveaRadius': 200.0, 'foveaSampleCount': 4.0, 'periphSampleCount': 1.0, 'uniformSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5, 'foveaMoveDirection': 0})
    ...
    DynamicWeightingSVGF = createPass('DynamicWeightingSVGF', {'Enabled': True, 'Iterations': 2, 'FeedbackTap': 0, 'GradientFilterIterations': 1, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'GammaRatio': 1.0})
    g.addPass(DynamicWeightingSVGF, 'DynamicWeightingSVGF')
    SVGFPass = createPass('SVGFPass', {'Enabled': True, 'Iterations': 2, 'FeedbackTap': 0, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224})
    ...
    ErrorMeasurePass = createPass('ErrorMeasurePass', {'ReferenceImagePath': WindowsPath('.'), 'MeasurementsFilePath': WindowsPath('.'), 'IgnoreBackground': True, 'ComputeSquaredDifference': True, 'ComputeAverage': False, 'UseLoadedReference': False, 'ReportRunningError': True, 'RunningErrorSigma': 0.9950000047683716, 'SelectedOutputId': OutputId.Source})
    ...
    ErrorMeasurePass0 = createPass('ErrorMeasurePass', {'ReferenceImagePath': WindowsPath('.'), 'MeasurementsFilePath': WindowsPath('.'), 'IgnoreBackground': True, 'ComputeSquaredDifference': True, 'ComputeAverage': False, 'UseLoadedReference': False, 'ReportRunningError': True, 'RunningErrorSigma': 0.9950000047683716, 'SelectedOutputId': OutputId.Source})
    ...
    g.addEdge('SVGFPass0.Filtered image', 'ErrorMeasurePass.Reference')
    g.addEdge('ErrorMeasurePass.Output', 'ToneMapper.src')
    g.addEdge('SVGFPass0.Filtered image', 'ErrorMeasurePass0.Reference')
    ...
    g.addEdge('ErrorMeasurePass0.Output', 'ToneMapper0.src')
