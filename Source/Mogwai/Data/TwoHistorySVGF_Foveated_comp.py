...
def render_graph_g():
    ...
    TwoHistorySVGFPass = createPass('TwoHistorySVGFPass', {'Enabled': True, 'SpatialFilterEnabled': True, 'TwoHistoryEnabled': True, 'Iterations': 2, 'FeedbackTap': 0, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.20000000298023224, 'WeightedAlpha': 0.20000000298023224, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'MaxGradient': 1000000.0, 'AutoMidpoint': True, 'GradientMidpoint': 0.5, 'GammaSteepness': 1.0, 'SelectionMode': 2, 'SampleCountOverride': -1, 'NormalizationMode': 3, 'UseInputReprojection': False, 'OutputPingPongAfterIters': 0, 'OutputPingPongIdx': 0, 'EnableDebugTag': False, 'EnableDebugOutput': False, 'EnableOutputVariance': False, 'FilterGradientEnabled': True, 'BestGammaEnabled': True, 'OptimalWeightingEnabled': False})
    g.addPass(TwoHistorySVGFPass, 'TwoHistorySVGFPass')
    TwoHistorySVGFPass0 = createPass('TwoHistorySVGFPass', {'Enabled': True, 'SpatialFilterEnabled': True, 'TwoHistoryEnabled': False, 'Iterations': 2, 'FeedbackTap': 0, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.20000000298023224, 'WeightedAlpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'MaxGradient': 1000000.0, 'AutoMidpoint': False, 'GradientMidpoint': 0.019999999552965164, 'GammaSteepness': 10.0, 'SelectionMode': 0, 'SampleCountOverride': -1, 'NormalizationMode': 0, 'UseInputReprojection': False, 'OutputPingPongAfterIters': 0, 'OutputPingPongIdx': 0, 'EnableDebugTag': False, 'EnableDebugOutput': False, 'EnableOutputVariance': True, 'FilterGradientEnabled': False, 'BestGammaEnabled': False, 'OptimalWeightingEnabled': False})
    g.addPass(TwoHistorySVGFPass0, 'TwoHistorySVGFPass0')
    ...
    g.addEdge('Composite.out', 'TwoHistorySVGFPass0.Albedo')
    g.addEdge('PathTracer.nrdEmission', 'TwoHistorySVGFPass0.Emission')
    g.addEdge('PathTracer.color', 'TwoHistorySVGFPass0.Color')
    g.addEdge('FoveatedPass.sampleCount', 'TwoHistorySVGFPass0.SampleCount')
    g.addEdge('GBufferRaster.pnFwidth', 'TwoHistorySVGFPass0.PositionNormalFwidth')
    g.addEdge('GBufferRaster.linearZ', 'TwoHistorySVGFPass0.LinearZ')
    g.addEdge('TwoHistorySVGFPass0.Filtered image', 'ToneMapper0.src')
    g.addEdge('GBufferRaster.posW', 'TwoHistorySVGFPass0.WorldPosition')
    g.addEdge('GBufferRaster.normW', 'TwoHistorySVGFPass0.WorldNormal')
    g.addEdge('GBufferRaster.mvec', 'TwoHistorySVGFPass0.MotionVec')
