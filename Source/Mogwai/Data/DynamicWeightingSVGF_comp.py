...
def render_graph_g():
    ...
    loadRenderPassLibrary('MultiPathTracer.dll')
    ...
    DynamicWeightingSVGF = createPass('DynamicWeightingSVGF', {'Enabled': True, 'Iterations': 2, 'FeedbackTap': 0, 'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'MaxHistoryLength': 8.0})
