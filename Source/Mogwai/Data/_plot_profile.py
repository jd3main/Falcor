...
iters, feedback = iter_params


folder_names = [
    f'{scene_name}_iters({iters},{feedback})_{selection_func}({midpoint},{steepness})_Alpha({alpha})_WAlpha({w_alpha})_GAlpha({g_alpha})_Norm({normalization_mode.name})_{sampling}',
