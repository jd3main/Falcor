...
def render_graph_g(iters=2, feedback=0, grad_iters=1):
    g = RenderGraph('g')
    ...
    FoveatedPass = createPass('FoveatedPass', {'shape': 2, 'foveaInputType': 1, 'useHistory': False, 'alpha': 0.05000000074505806, 'foveaRadius': 200.0, 'foveaSampleCount': 8.0, 'periphSampleCount': 1.0, 'foveaMoveRadius': 300.0, 'foveaMoveFreq': 0.5, 'foveaMoveDirection': 0, 'useRealTime': False, 'flickerEnabled': False, 'flickerBrightDurationMs': 1.0, 'flickerDarkDurationMs': 1.0})
    ...
    DynamicWeightingSVGF = createPass('DynamicWeightingSVGF',
                                      {
                                        'Enabled': True,
                                        'DynamicWeighingEnabled': True,
                                        'Iterations': iters,
                                        'FeedbackTap': feedback,
                                        'GradientFilterIterations': grad_iters,
                                        'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'GradientMidpoint': 0.004999999888241291, 'GammaSteepness': 300.0, 'SelectionMode': 4, 'SampleCountOverride': -1, 'NormalizationMode': 3})
    g.addPass(DynamicWeightingSVGF, 'DynamicWeightingSVGF')
    SVGFPass = createPass('DynamicWeightingSVGF',
                          {
                            'Enabled': True,
                            'DynamicWeighingEnabled': False,
                            'Iterations': iters,
                            'FeedbackTap': feedback,
                            'GradientFilterIterations': grad_iters,
                            'VarianceEpsilon': 9.999999747378752e-05, 'PhiColor': 10.0, 'PhiNormal': 128.0, 'Alpha': 0.05000000074505806, 'MomentsAlpha': 0.20000000298023224, 'GradientAlpha': 0.20000000298023224, 'GradientMidpoint': 0.009999999776482582, 'GammaSteepness': 100.0, 'SelectionMode': 0, 'SampleCountOverride': -1, 'NormalizationMode': 0})
    ...
    GroundTruthSVGFPass = createPass('DynamicWeightingSVGF',
                                     {
                                        'Enabled': True,
                                        'DynamicWeighingEnabled': False,
                                        'Iterations': iters,
    ...
    g.addEdge('FoveatedPass.sampleCount', 'CountToColor.Count')
